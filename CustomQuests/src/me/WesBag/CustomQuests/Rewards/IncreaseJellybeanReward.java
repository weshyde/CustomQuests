...
public class IncreaseJellybeanReward extends CustomReward {
	
	public IncreaseJellybeanReward() {
		this.setName("Increase Jellybean Reward");
		this.setAuthor("WesBag");
		
		this.addStringPrompt("Increase-Amt", "Enter the amount the jellybean pouch will increase", 0);
	}
	...
	public void giveReward(Player player, Map<String, Object> data) {
		...
		int newAmt = toon.getJellybeansPouchMax() + increaseAmt;
		toon.setJellybeanPouchMax(newAmt);
	}
